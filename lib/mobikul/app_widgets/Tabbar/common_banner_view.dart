                    ...
                    Padding(
                        ...
                        child: Column(
                          children: [
                            Text(
                              name,
                              style: Theme.of(context).textTheme.headline5?.copyWith(fontSize: AppSizes.textSizeMedium, color: Colors.white),
                            ),
                            const SizedBox(height: AppSizes.spacingTiny,),
                            Text(
                              email,
                              style: Theme.of(context).textTheme.bodyText2?.copyWith(fontSize: AppSizes.textSizeMedium, color: Colors.white),
                            ),
                                ...
                                child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Text(
                                        ...
                                        style: Theme.of(context).textTheme.bodyText2?.copyWith(fontSize: AppSizes.textSizeSmall, color: Colors.white),
                                      ),
                                    )
                                ),
                              ),
